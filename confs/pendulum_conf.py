...
u_min = 10
u_max = 10                                                                                         # Control input bounds (torque)
X_INIT_MIN = np.array([0., -10., 0.])                                                               # Initial angle (θ),  angular velocity (w), timestep (t)
X_INIT_MAX = np.array([2*np.pi, +10., (NSTEPS-1)*dt])                                               # Final angle (θ),  angular velocity (w), timestep (t)
